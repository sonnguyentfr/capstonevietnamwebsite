        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                If Not Page.IsPostBack Then
                    ...
                    'ImageResizer.ImageBuilder.Current.Build("http://nvcmsv2pc.vn/data/ongkhangtatbaxuan.gif", "ongkhangtatbaxuan", New ImageResizer.ResizeSettings("width=600;height=315;format=gif;mode=min"), True)
                End If
