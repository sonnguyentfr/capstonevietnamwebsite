...
namespace DesktopModules.NV_Events.Manager.template
{
    ...
    {
        private string PageAddURL = "/quantri/quan-tri-su-kien/faq-template.html?mod=edit";
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                TemplateInfo template = controller._GetByID(templateID, PortalId);
                
                if (template != null)
                {
                    string filePath = "/Portals/0/FAQs/" + template.FilePath;
        ...
        protected void gridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowIndex >= 0) //Bo qua dong dau
                {
                    ...
                    e.Row.Cells[2].Text = "/Portals/0/FAQs/" + e.Row.Cells[2].Text;
