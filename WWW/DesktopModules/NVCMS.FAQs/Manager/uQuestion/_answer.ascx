<%@ Control Language="vb" AutoEventWireup="false" Explicit="true" CodeFile="_answer.ascx.vb" Inherits="NVCMS.Modules.FAQs.inc_edit" %>
            ...
            <div class="card card-bordered h-100">
                <div class="card-inner">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="<%#txttochuccanhanh.ClientID %>">Tổ chức, cá nhân</label>
                            <asp:TextBox ID="txttochuccanhanh" runat="server" CssClass="form-control" Font-Size="14px"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="<%#lblAddress.ClientID %>">Địa chỉ</label>
                            <div class="form-control-wrap">
                                <asp:TextBox ID="lblAddress" Enabled="false" runat="server" CssClass="form-control" Font-Size="14px" TextMode="MultiLine"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="<%#lblTite.ClientID %>">Tiêu đề</label>
                            <asp:TextBox ID="lblTite" Enabled="false" runat="server" CssClass="form-control" Font-Size="14px"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="<%#lblQuestion.ClientID %>">Câu hỏi</label>
                            <div class="form-control-wrap">
                                <asp:TextBox ID="lblQuestion" Enabled="false" runat="server" CssClass="form-control" Font-Size="14px" TextMode="MultiLine"></asp:TextBox>
