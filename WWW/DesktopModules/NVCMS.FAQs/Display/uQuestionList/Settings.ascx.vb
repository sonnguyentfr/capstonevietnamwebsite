...
#Region "Event Handlers"
        Public Overrides Sub LoadSettings()
            Try
                If (Page.IsPostBack = False) Then
                    BindTemplate()
                    If Not Null.IsNull(ModuleConfiguration.ModuleSettings("uFAQs_StyleSettings")) Then
                        Me.dropTemplate.SelectedValue = ModuleConfiguration.ModuleSettings("uFAQs_StyleSettings").ToString()
                    End If
                    If Not Null.IsNull(ModuleConfiguration.ModuleSettings("uFAQs_PageSize")) Then
                        Me.txtSL.Text = ModuleConfiguration.ModuleSettings("uFAQs_PageSize").ToString()
                    End If
                End If
        ...
        Public Overrides Sub UpdateSettings()
            Try
                ...
                objModules.UpdateModuleSetting(ModuleId, "uFAQs_PageSize", Me.txtSL.Text)
            Catch exc As Exception    'Module failed to load
                ProcessModuleLoadException(Me, exc)
            End Try
        End Sub
