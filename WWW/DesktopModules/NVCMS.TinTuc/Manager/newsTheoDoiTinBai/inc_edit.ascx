<%@ Control Language="vb" AutoEventWireup="false" Explicit="true" CodeFile="inc_edit.ascx.vb" Inherits="DesktopModules.TinTuc.Manager.news.newsedit" EnableViewState="true" %>
            ...
            <div class="card card-bordered">
                <div class="card-header border-bottom">
                    <ul class="cc_button">
                        ...
                        <li>
                            <asp:LinkButton ID="lbtTralaiTacGia" ValidationGroup="InputValidate" runat="server" CssClass="btn  btn-sm  btn-primary" OnClientClick="formModified=false;">
                                <span>Trả lại tác giả</span><em class="icon ni ni-arrow-up-left"></em>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="lbtTralaiBientap" ValidationGroup="InputValidate" runat="server" CssClass="btn  btn-sm  btn-warning" OnClientClick="formModified=false;">
                                <span>Trả lại biên tập</span><em class="icon ni ni-arrow-up-left"></em>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="lbtGuiBienTap" ValidationGroup="InputValidate" runat="server" CssClass="btn  btn-sm  btn-warning" OnClientClick="formModified=false;">
                                <span>Gửi biên tập</span><em class="icon ni ni-arrow-right-circle"></em>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="lbtHuyXuatBan" ValidationGroup="InputValidate" runat="server" CssClass="btn  btn-sm  btn-warning" OnClientClick="formModified=false;">
                                <span>Hủy xuất bản</span><em class="icon ni ni-arrow-right-circle"></em>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="lbtGuiXuatBan" ValidationGroup="InputValidate" runat="server" CssClass="btn  btn-sm  btn-success" OnClientClick="formModified=false;">
                                <span>Gửi xuất bản</span><em class="icon ni ni-chevrons-right"></em>
                            </asp:LinkButton>
                        </li>
                        <li>
                ...
                <div class="card-inner">
                                        ...
                                        <ul>
                                            <asp:Repeater runat="server" ID="rptRelated">
                                                <ItemTemplate>
                                                    <li>
                                                        <a href="#"><%# Eval("Title")%> </a>
                                                        <a class="delRelated" onclick="javascript:delRl(this,<%# Eval("NewId")%>);" title="Xóa tin" style="cursor: pointer;"><em class="icon ni ni-trash-fill"></em></a>
                                                    </li>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </ul>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <asp:TextBox ID="txtLuuY" runat="server" TextMode="MultiLine" Rows="3" Width="100%" Enabled="False"></asp:TextBox>
                            <input type="text" class="addText" id="txtLuuYAdd" value="Nhập lưu ý" title="Nhập lưu ý" style="width: 90%;" />
                            <input type="button" id="btnSend" value="Gửi" />
                        </div>
                    </div>
                    <div class="form-group" id="trButPhe" runat="server" visible="false">
                        <asp:DataGrid ID="drgDataViewer" DataKeyField="ID" Width="100%" runat="server" AllowPaging="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Bút phê">
                                    <ItemTemplate>
                                        <asp:Label ID="lblButPhe" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Comment").ToString().Replace(ControlChars.NewLine, "<br>") %>'></asp:Label>
                                        <br />
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
...
<asp:HiddenField ID="hdf_luuy" runat="server" />
...
<script type="text/javascript">
    //Xu ly Tag tự động
    $(".huongvitinhthan").click(function () {
...
<script language="javascript" type="text/javascript">
    ...
    function FetchData() {
        ...
        luuy = Base64.encode($('#<%=txtLuuY.ClientID %>').val());
...
<script type="text/javascript">
    $('.addText').bind("enterKey", function (e) {
        $('#<%=txtLuuY.ClientID %>').val('<%=UserInfo.UserName %>' + "(" + GetDateStamp() + "): " + $(this).val() + "\n" + $('#<%=txtLuuY.ClientID %>').val());
        $('#<%=hdf_luuy.ClientID %>').val('<%=UserInfo.UserName %>' + "(" + GetDateStamp() + "): " + $(this).val() + "\n" + $('#<%=hdf_luuy.ClientID %>').val());
        $(this).val("");
    });
    ...
    function HandlePopupResult(result) {
        ...
        for (var i = 0; i < arr.length; i++) {
            if (arr[i] != null && arr[i] != '') {
                ...
                addValue('<%= hdf_Related.ClientID %>', sid);
                $('.list-lq ul').append('<li><a href="#"> ' + stitle + '</a><a class="delRelated" onclick="javascript:delRl(this,' + sid + ');" title="Xóa tin" style="cursor:pointer;"><em class="icon ni ni-trash-fill"></em></a></li>');
            }
        }
    }
