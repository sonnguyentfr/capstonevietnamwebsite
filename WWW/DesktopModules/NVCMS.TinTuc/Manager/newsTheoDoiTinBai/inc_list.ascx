            ...
            <div class="card card-bordered card-stretch">
                <div class="card-inner-group">
                                                            ...
                                                            <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-right">
                                                                ...
                                                                <div class="dropdown-body dropdown-body-rg">
                                                                    <div class="row gx-6 gy-3">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <label class="overline-title overline-title-alt">Trạng thái tin</label>
                                                                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-select form-control form-control-sm" AutoPostBack="true"></asp:DropDownList>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <div class="preview-block">
                                                                                    <span class="preview-title overline-title">Hiện thị tin đã xóa</span>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <asp:CheckBox ID="chkIsActive" runat="server" AutoPostBack="true" CssClass="custom-control-input"></asp:CheckBox>
                                                                                        <label class="custom-control-label" for="<%=chkIsActive.ClientID %>">Chọn</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                    ...
                    <div class="card-inner p-0">
                        ...
                        <asp:LinkButton ID="lbtShowNews" Visible="false" Font-Bold="true" CssClass="btn btn-primary btn-dim btn-outline-light" OnClientClick="javascript:return confirm('Trả lại tin bài đã chọn?');" runat="server">
                            <em class="icon ni ni-arrow-up-left"></em><span>Khôi phục tin bài</span>
                        </asp:LinkButton>
                        ...
                        <asp:LinkButton ID="lbtHideNews" Font-Bold="true" CssClass="btn btn-dark btn-dim btn-outline-light" OnClientClick="javascript:return confirm('Trả lại tin bài đã chọn?');" runat="server">
                            <em class="icon ni ni-property-remove"></em><span>Xóa tạm</span>
                        </asp:LinkButton>
                    </div>
                    <div class="card-inner p-0">
                        <div class="nk-tb-list nk-tb-ulist" id="datatable">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col tb-col-mb"><span class="sub-text">Trạng thái</span></div>
                            ...
                            <asp:Repeater ID="drgDataViewer" runat="server">
                                <ItemTemplate>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col">
                                            <div class="user-card">
                                                ...
                                                <div class="user-info">
                                                    ...
                                                    <br />
                                                    <small><font style="color: Maroon;">Tác giả: </font><%# BL.GetSend2ApprovalInfo(PortalId, Eval("UserId"), Eval("ApprovalRequestDate")) %> Ngày tạo: <%# DataBinder.Eval(Container.DataItem, "CreateDate") %>
                                                    </small>
                                                    <br />
                                                    <small>
                                                    ...
                                                    <small>
                                                        ...
                                                        <asp:LinkButton ID="cmdUnlock" CssClass="btn btn-trigger" ForeColor="Orange" OnClick="GetUnlockNews" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "newid") %>' Visible='<%# Eval("IsEdited") %>' runat="server" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mở khóa tin bài">
                                        ...
                                        <div class="nk-tb-col tb-col-mb">
                                            <%#Ultis.GetNameStatusName(DataBinder.Eval(Container.DataItem, "Status"))%>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
