...
#Region "Ajax"
        ...
        Public Function RaiseClientAPICallbackEvent(ByVal eventArgument As String) As String Implements DotNetNuke.UI.Utilities.IClientAPICallbackEventHandler.RaiseClientAPICallbackEvent
            ...
            Return ""
        End Function
        Private Function AutoSave(ByVal sID As String, ByVal title64 As String, ByVal loaitinbai As String, ByVal tinnongchuyenmuc As Boolean, ByVal tinnongsite As Boolean, ByVal chuyenmucchinh As Integer, ByVal chuyenmucphu As String, ByVal tomtat64 As String, ByVal he As String, ByVal noidung64 As String, ByVal nguontin As String, ByVal dongtg As String, ByVal luuy64 As String, ByVal links64 As String, ByVal anhdd64 As String, mediaList64 As String, imgList64 As String, isVideo As Boolean, isPhoto As Boolean, isPr As Boolean, isShowBaiMoi As Boolean, isAMP As Boolean, isHienQuangCao As Boolean, isAnNoiDung As Boolean, keyword64 As String, butdanh64 As String, SourceText64 As String, chkconfighotslide As Boolean, chkconfigtinnong As Boolean, chkconfigxuhuongdoc As Boolean, sTags64 As String) As Integer
            Try
                'Title = "" van luu.
                ...
                Try
                    ...
                    If Request.Item("itemid") <> "" Then
                        ...
                        If objNews.IsEdited Then
                            Response.Redirect(BL.pageTheoDoiTinBai)
                        Else
                            Ultis.LockNews(ItemID, UserId)
                        End If
                        If Not objNews Is Nothing Then
                            With objNews
                                'Cho nay kiem tra trang thai bai viet
                                If .Status = NewsStatus.DangBienSoan Then
                                    lbtTralaiTacGia.Visible = False
                                    lbtTralaiBientap.Visible = False
                                    lbtGuiBienTap.Visible = True
                                    lbtGuiXuatBan.Visible = True
                                    lbtHuyXuatBan.Visible = False
                                End If
                                If .Status = NewsStatus.ChoPheDuyet Then
                                    lbtTralaiTacGia.Visible = True
                                    lbtTralaiBientap.Visible = False
                                    lbtGuiBienTap.Visible = False
                                    lbtGuiXuatBan.Visible = True
                                    lbtHuyXuatBan.Visible = False
                                End If
                                If .Status = NewsStatus.ChoXuatBan Then
                                    lbtTralaiTacGia.Visible = True
                                    lbtTralaiBientap.Visible = True
                                    lbtGuiBienTap.Visible = False
                                    lbtGuiXuatBan.Visible = False
                                    lbtHuyXuatBan.Visible = False
                                End If
                                If .Status = NewsStatus.DaXuatBan Then
                                    ...
                                    lbtGuiBienTap.Visible = False
                                    lbtGuiXuatBan.Visible = False
                                    lbtHuyXuatBan.Visible = True
                                    lbtSaveXB.Visible = False
                                End If
                                If .Status = NewsStatus.HuyXuatBan Then
                                    lbtTralaiTacGia.Visible = True
                                    lbtTralaiBientap.Visible = True
                                    lbtGuiBienTap.Visible = False
                                    lbtGuiXuatBan.Visible = False
                                ...
                                If (.PublishedDate.ToString() Is Nothing) Or (.PublishedDate <> "01/01/0001") Then
...
#Region "Button Action"
        ...
        Protected Sub lbtSaveXB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtSaveXB.Click
            Try
                ...
                End If
                '8. Return
                Response.Redirect(BL.pageTheoDoiTinBai, False)
        ...
        ''' <param name="sender"></param>
        ''' <param name="e"></param>
        Protected Sub lbtTralaiTacGia_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtTralaiTacGia.Click
            Try
                AddNews()
        ...
        ''' <param name="sender"></param>
        ''' <param name="e"></param>
        Protected Sub lbtTralaiBientap_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtTralaiBientap.Click
            Try
                AddNews()
                '2 Cập nhật nhuận bút vào NEWS
                '3. Process 2 Users
...
#Region "Logic Handlers"
        ...
        Private Sub BindButPhe()
            ...
            Dim arrResult As New ArrayList
            Dim arrTemp As ArrayList = ctl.GetByNewsId(ItemID)
            For Each obj As NewsProcessInfo In arrTemp
                If Not String.IsNullOrEmpty(obj.Comment) Then
                    arrResult.Add(obj)
                End If
            Next
            If arrResult.Count > 0 Then
                trButPhe.Visible = True
                Me.drgDataViewer.DataSource = arrResult
