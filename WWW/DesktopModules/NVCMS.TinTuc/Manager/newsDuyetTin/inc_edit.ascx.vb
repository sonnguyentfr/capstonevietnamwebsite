            ...
            If Not IsPostBack Then
                ...
                Try
                    ...
                    If Request.Item("itemid") <> "" Then
                        ...
                        'NẾU BÀI ĐÃ LOCK -> OUT
                        If Not Ultis.FormatVisibleByStatus(PortalId, objNews.IsApprovalState, ItemID) Then
                            Response.Redirect(BL.pagePheDuyet)
                        Else
                        ...
                        If Not objNews Is Nothing Then
                            With objNews
                                ...
                                If (.PublishedDate.ToString() Is Nothing) Or (.PublishedDate <> "01/01/0001") Or (.PublishedDate <> "01/01/2000") Then
                                    Me.txtPublishedDate.Text = .ApprovalRequestDate.ToString("dd/MM/yyyy HH:mm")
                                Else
...
#Region "Button Action"
        ...
        Protected Sub lbtSaveGuiXB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtSaveGuiXB.Click
            Try
                ...
                ClientAPI.RegisterStartUpScript(Me.Page, "UpdateSuccess", "<script>UpdateSuccess('sadadas!');</script>")
                '3. Process 2 Users
                With objProcessInfo
                    .NewsID = ItemID
                    .CreateDate = DateTime.Now
                ...
                objNewsInfo = CollectNewsInfo(objNewsInfo)
                '7. Return
                Response.Redirect(BL.pagePheDuyet, False)
