...
#Region "Event Handlers"
        Public Overrides Sub LoadSettings()
            Try
                If (Page.IsPostBack = False) Then
                    BindDdlStatus()
                    If IsNumeric(ModuleSettings("TintucAdminNewsStatus")) Then
                        Me.ddlStatus.SelectedValue = CType(ModuleSettings("TintucAdminNewsStatus"), Integer)
                    End If
        ...
        Public Overrides Sub UpdateSettings()
            Try
                ...
                objModules.UpdateModuleSetting(ModuleId, "TintucAdminNewsStatus", Me.ddlStatus.SelectedValue)
