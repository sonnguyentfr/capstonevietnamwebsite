            ...
            <div class="card card-bordered">
                <div class="card-header border-bottom">
                    <ul class="cc_button">
                        ...
                        <li>
                            <asp:LinkButton ID="lbtSaveGuiXB" Visible="false" ValidationGroup="InputValidate" runat="server" CssClass="btn  btn-sm  btn-warning">
    ...
    <div class="modal-dialog modal-xl modal-dialog-top" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Bút phê Trả lại bài viết</h5>
            </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        $('#checkbox-tree').jstree({
            ...
            //alert($('#checkbox-tree').jstree("get_selected"));
            document.getElementById('<%=hdf_subCategories.ClientID%>').value = $('#checkbox-tree').jstree("get_selected");
        });
    })
</script>
...
<script language="javascript" type="text/javascript">
    ...
    function ClientNodeChecked(sender, eventArgs) {
        formModified = true;
        subcategory = "";
        subcategory = $('#checkbox-tree').jstree("get_selected");
    }
