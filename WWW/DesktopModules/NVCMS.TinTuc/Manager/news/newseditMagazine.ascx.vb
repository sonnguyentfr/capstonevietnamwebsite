...
#Region "Ajax"
        ...
        Public Function RaiseClientAPICallbackEvent(ByVal eventArgument As String) As String Implements DotNetNuke.UI.Utilities.IClientAPICallbackEventHandler.RaiseClientAPICallbackEvent
            ...
            Return ""
        End Function
        Private Function AutoSave(ByVal sID As String, ByVal title64 As String, ByVal loaitinbai As String, ByVal tinnongchuyenmuc As Boolean, ByVal tinnongsite As Boolean, ByVal chuyenmucchinh As Integer, ByVal chuyenmucphu As String, ByVal tomtat64 As String, ByVal he As String, ByVal noidung64 As String, ByVal nguontin As String, ByVal dongtg As String, ByVal luuy64 As String, ByVal links64 As String, ByVal anhdd64 As String, mediaList64 As String, imgList64 As String, isVideo As Boolean, isPhoto As Boolean, isPr As Boolean, isShowBaiMoi As Boolean, isAMP As Boolean, isHienQuangCao As Boolean, isAnNoiDung As Boolean, keyword64 As String, butdanh64 As String, SourceText64 As String, chkconfighotslide As Boolean, chkconfigtinnong As Boolean, chkconfigxuhuongdoc As Boolean, sTags As String) As Integer
            Try
                'Title = "" van luu.
...
#Region "Logic Handlers"
        ...
        Private Sub BindRadTreeCategory()
            ...
            radTreeCategory.DataSource = arr
            radTreeCategory.DataTextField = "CategoryName"
            radTreeCategory.DataFieldID = "CategoryID"
            radTreeCategory.DataFieldParentID = "ParentId"
            radTreeCategory.DataValueField = "CategoryID"
            radTreeCategory.DataBind()
        End Sub
        Private Sub ReconfigNodeChecked()
            hdf_subCategories.Value = String.Empty

            radTreeCategory.TriStateCheckBoxes = False 'Disable tristate handling
            ...
            For Each node As RadTreeNode In radTreeCategory.GetAllNodes
                For Each obj As NewsByCategoryInfo In arr
                    If obj.CategoryId = CInt(node.Value) Then
                        node.Checked = True
                        hdf_subCategories.Value += "," + node.Value
                        Exit For
                    End If
                Next
            Next

            If hdf_subCategories.Value.Length > 0 Then
                hdf_subCategories.Value = hdf_subCategories.Value.Substring(1)
            End If
            radTreeCategory.TriStateCheckBoxes = True 'Enable back tristate handling
        End Sub
