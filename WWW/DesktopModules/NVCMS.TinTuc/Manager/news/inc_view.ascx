<%@ Control Language="vb" AutoEventWireup="false"  Explicit="true" codefile="inc_view.ascx.vb" Inherits="DesktopModules.TinTuc.Manager.news.inc_view" %>
        ...
        <div class="toolbarBox toolbarHead">
            <ul class="cc_button">
                <li style="padding-left:20px;">
                    <asp:linkbutton id="lbtApproveTop" runat="server" Font-Bold="True" CssClass="toolbar_btn">
                        <img src="/images/icons/page_go.png" alt="Thực hiện"/> Thực hiện => 
                    </asp:linkbutton>
                </li>
                <li>
                    <asp:DropDownList ID="ddlWFTop" runat="server" DataTextField="TenLuong" DataValueField="ID"></asp:DropDownList>
                </li>
                <li>
                    <asp:linkbutton id="lbtUyNhiemXB" ValidationGroup="InputValidate" runat="server" Font-Bold="True" CssClass="toolbar_btn">
                        <img src="/images/icons/world_go.png" alt="Thực hiện xuất bản ủy nhiệm" /> Thực hiện XB ủy nhiệm
                    </asp:linkbutton>
                </li>
                ...
                <li style="padding-left:20px;"><asp:linkbutton id="lbtCancelTop" runat="server" Font-Bold="True" CssClass="toolbar_btn"><img src="/images/icons/arrow_rotate_clockwise.png" alt="Thoát" /> Thoát</asp:linkbutton></li>
                <li style="padding-left:20px;">
                ...
                <li style="float:right; padding-right:10px;"><asp:linkbutton id="lbtDeleteTop" runat="server" Font-Bold="True" CssClass="toolbar_btn" OnClientClick="return confirm('Bạn có thực sự muốn xóa các tin đã chọn không?');"><img src="/images/icons/delete.png" alt="Xoá tin" /> Xoá tin</asp:linkbutton></li>
            </ul>
            <div class="clear"></div>
        </div>
    </div>
        ...
        <td>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr id="trButPhe" runat="server">
                    <td class="w-label" style="width:100px;"></td>
                    <td class="w-control">
