            ...
            If Not IsPostBack Then
                ...
                Try
                    ...
                    Else
                        ...
                        AddNews()
                        'Trường liên quan khi tạo mới - không cần load, hdf_Schools rỗng là đủ
        ...
        Private Sub AddNews()
            Try
                ...
                If ItemID <> 0 Then
                    ...
                    '1.5 Trường liên quan
                    SaveNewsBySchool(ItemID)
                    '1.6 Update tac gia va nhuan but
                ...
                Else 'Add New
                    ...
                    '4. Trường liên quan
                    SaveNewsBySchool(ItemID)
                    '5. Cap nhat tac gia vào bằng news
