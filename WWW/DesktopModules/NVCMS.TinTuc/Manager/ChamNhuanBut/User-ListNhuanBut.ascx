<%@ Control Language="vb" Inherits="NVCMS.Modules.TinTuc.NhuanButView" ClientIDMode="Static" CodeFile="User-ListNhuanBut.ascx.vb" AutoEventWireup="false" Explicit="True" %>
                    ...
                    <table class="table table-hover" id="nhuanbut">
                        <thead class="thead-dark thead-light">
                            ...
                            <tr>
                                ...
                                <th>Gi&aacute; trị Tin
                                    <br />
                                    <strong><p id="TienTin"></p></strong>
                                </th>
                                <th>Gi&aacute; trị B&agrave;i
                                    <br />
                                    <strong><p id="TienBai"></p></strong>
                                </th>
                                <th>Gi&aacute; trị Ảnh
                                    <br />
                                    <strong><p id="TienAnh"></p></strong>
                                </th>
                                <th>Gi&aacute; trị Video
                                    <br />
                                    <strong><p id="TienVideo"></p></strong>
                                </th>
                                <th>Người tạo</th>
                            ...
                            <asp:Repeater ID="rptData" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="width: 100px; text-align: center;" class="auto currency tientin"><%#TienTin(CInt(CInt(Eval("Newid"))), 4)%></td>
                                        <td style="width: 100px; text-align: center;"><span class="auto currency tienbai"><%#TienTin(CInt(Eval("Newid")), 1)%></span></td>
                                        <td style="width: 100px; text-align: center;" class="auto currency tienanh"><%#TienTin(CInt(Eval("Newid")), 2)%></td>
                                        <td style="width: 100px; text-align: center;" class="auto currency"><%#TienTin(CInt(Eval("Newid")), 3)%></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var sumtientin = 0;
        $(".tientin").each(function () {
            if (!isNaN(this.value) && this.value.length != 0) {
                sumtientin += parseFloat(this.value);
            }
            //$("#TienTin").val(sumtientin);
            document.getElementById("TienTin").innerHTML = sumtientin;
            console.log(sumtientin);
        });
        //
        var sumtienbai = 0;
        $(".tienbai").each(function () {
            if (!isNaN(this.value) && this.value.length != 0) {
                sumtienbai += parseFloat(this.value);
            }
            document.getElementById("TienBai").innerHTML = sumtienbai;
            console.log(sumtienbai);
        });
