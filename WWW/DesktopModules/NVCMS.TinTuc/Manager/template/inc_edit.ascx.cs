...
namespace DesktopModules.TinTuc.Manager.template
{
  ...
  "óòọỏõôốồộổỗơớờợởỡ", "úùụủũưứừựửữ", "íìịỉĩ","đ", "ýỳỵỷỹ", };
        ...
        {
            folderPath = PortalSettings.HomeDirectoryMapPath + "NewsTemplates";
        ...
        private void FillData()
        {
            ...
            NV_NewsTemplateInfo template = controller.GetTemplate(PortalId, id);
            if (template == null) return;
            txtTemplateName.Value = template.TemplateName;
            txtFilePath.Value = PortalSettings.HomeDirectory + "/NewsTemplates/" + template.FilePath;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            NV_NewsTemplateInfo template = (id == -1 ? new NV_NewsTemplateInfo() : controller.GetTemplate(PortalId, id));
