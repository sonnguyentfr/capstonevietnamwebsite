<%@ Control Language="C#" AutoEventWireup="true" CodeFile="inc_list.ascx.cs" Inherits="DesktopModules.TinTuc.Manager.template.inc_list" %>
<style type="text/css">
...
<div id="gridview">
    <asp:GridView ID="gridView" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True"
        ...
        <Columns>
            <asp:BoundField DataField="TemplateID" HeaderText="ID" ReadOnly="true">
