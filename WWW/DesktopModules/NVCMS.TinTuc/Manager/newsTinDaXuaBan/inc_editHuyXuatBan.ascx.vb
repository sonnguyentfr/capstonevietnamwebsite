...
#Region "Ajax"
        ...
        Public Function RaiseClientAPICallbackEvent(ByVal eventArgument As String) As String Implements DotNetNuke.UI.Utilities.IClientAPICallbackEventHandler.RaiseClientAPICallbackEvent
            ...
            Return ""
        End Function
        Private Function AutoSave(ByVal sID As String, ByVal title64 As String, ByVal loaitinbai As String, ByVal tinnongchuyenmuc As Boolean, ByVal tinnongsite As Boolean, ByVal chuyenmucchinh As Integer, ByVal chuyenmucphu As String, ByVal tomtat64 As String, ByVal he As String, ByVal noidung64 As String, ByVal nguontin As String, ByVal dongtg As String, ByVal luuy64 As String, ByVal links64 As String, ByVal anhdd64 As String, mediaList64 As String, imgList64 As String, isVideo As Boolean, isPhoto As Boolean, isPr As Boolean, isShowBaiMoi As Boolean, isAMP As Boolean, isHienQuangCao As Boolean, isAnNoiDung As Boolean, keyword64 As String, butdanh64 As String, SourceText64 As String, chkconfighotslide As Boolean, chkconfigtinnong As Boolean, chkconfigxuhuongdoc As Boolean, sTags64 As String, txtPublishedDate64 As String) As Integer
            Try
                'Title = "" van luu.
                ...
                b = Convert.FromBase64String(txtPublishedDate64)
                Dim txtPublishedDate As String = System.Text.Encoding.UTF8.GetString(b)
                ...
                With objNews
                    ...
                    .Tags = sTags
                    If IsDate(txtPublishedDate) Then
                        .PublishedDate = Date.ParseExact(txtPublishedDate, "dd/MM/yyyy HH:mm", CultureInfo.InvariantCulture)
                    End If
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            If Not IsPostBack Then
                ...
                Try
                    ...
                    'lbtTraLaiBienTap.Visible = Ultis.ButtonGuiXuatBan(UserId)
                    lbtXuatBan.Visible = Ultis.ButtonXuatBanLuon(UserId)
                    '====================================
                    BindddlCategories()
                    BindRadTreeCategory()
                    'Nhuan but
                    ...
                    If Request.Item("itemid") <> "" Then
                        ...
                        If objNews.IsEdited Then
                            Response.Redirect(BL.pageHuyXuatBan)
                        Else
                            Ultis.LockNews(ItemID, UserId)
                        End If
                        If Not objNews Is Nothing Then
                            With objNews
                                If UserId = 1 Or UserId = 4 Or UserId = 12 Or UserId = 26 Then
                                ...
                                'Ngay huy xuat bản
                                If (.CancelPublishDate.ToString() Is Nothing) Or (.CancelPublishDate <> "01/01/0001") Then
                                    Me.txtunPublishedDate.Text = .CancelPublishDate.ToString("dd/MM/yyyy HH:mm")
                                Else
                                    Me.txtunPublishedDate.Text = .CancelPublishDate.ToString("dd/MM/yyyy HH:mm")
                                End If
                                Me.ltrUserUnpulioch.Text = BL.GetButDanh(PortalId, .CancelPublishUser)
                                '--
...
#Region "Button Action"
        ...
        ''' <param name="sender"></param>
        ''' <param name="e"></param>
        Protected Sub lbtXuatBan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtXuatBan.Click
            Try
                AddNews()
                ...
                With objProcessInfo
                    ...
                    .IPTrack = Request.ServerVariables("REMOTE_ADDR")
                    .ProcessName = "Thực hiện Xuất bản LẠI => "
                End With
                ctlProcess.Insert(objProcessInfo)
                ...
                '8. Return
                Response.Redirect(BL.pageHuyXuatBan, False)
