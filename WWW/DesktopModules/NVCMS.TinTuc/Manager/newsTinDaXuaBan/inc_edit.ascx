            ...
            <div class="card card-bordered">
                <div class="card-header border-bottom">
                    <ul class="cc_button">
                        ...
                        <li>
                            <a href="#" class="btn  btn-sm  btn-danger" data-toggle="modal" data-target="#modal-newsnote-submit3">
                                <span>Hủy Xuất bản</span> <em class="icon ni ni-check-circle"></em>
                            </a>
                        </li>
                        <li>
                            ...
                            <div class="cauhinhtin g-2 align-center flex-wrap">
                                ...
                                <div class="g">
                                    <div class="custom-control custom-control-sm custom-checkbox text-danger" id="Dechoxemnoidung" runat="server" visible="false">
                                        ...
                                        <label class="custom-control-label text-danger" for="<%=chkAnNoiDung.ClientID %>">Ẩn nội dung</label>
                                    </div>
                                </div>
                                <div class="g">
                                    <div class="custom-control custom-control-sm custom-checkbox text-danger" id="Dechoxemnoidung2" runat="server" visible="false">
...
<%--Modal Lưu ý bút phê Hủy Xuất bản--%>
<div class="modal fade" tabindex="-1" id="modal-newsnote-submit3">
    <div class="modal-dialog modal-xl modal-dialog-top" role="document">
        <div class="modal-content">
            <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                <em class="icon ni ni-cross"></em>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="form-control-wrap">
                        <asp:TextBox ID="txtLuubutphephop3" runat="server" TextMode="MultiLine" CssClass="form-control no-resize newsnotes"></asp:TextBox>
                        <asp:RequiredFieldValidator ValidationGroup="InputValidateNewsNotepop3" ControlToValidate="txtLuubutphephop3" CssClass="NormalRed" Display="Dynamic" ID="RequiredFieldValidator6" runat="server" ErrorMessage="Nhập lý do Hủy xuất bản!"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator
                            ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtLuubutphephop3" ValidationGroup="InputValidateNewsNotepop3"
                            Display="Dynamic" CssClass="NormalRed" ErrorMessage="Nhập nhiều vào"
                            ForeColor="" ValidationExpression=".{3}.*"></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class="form-group">
                    <asp:LinkButton ID="lbtHuyXuatBan" ValidationGroup="InputValidateNewsNotepop3" runat="server" Font-Bold="True" CssClass="btn btn-warning">
                            <span>Hủy xuất bản</span><em class="icon ni ni-save-fill"></em>
                    </asp:LinkButton>
                </div>
                <div class="form-group">
                    <ul class="newsnote">
                        <asp:Repeater ID="rptNotes4" runat="server">
                            <ItemTemplate>
                                <li>
                                    <b><%#BL.GetButDanh(PortalId, Eval("UserId")) %></b> <small><%#BL.FormatDate(Eval("CreatedDate")) %></small>: <%#Eval("NoiDung") %>
                                </li>
...
<script language="javascript" type="text/javascript">
    ...
    function FetchData() {
        ...
        txtPublishedDate = Base64.encode($('#<%=txtPublishedDate.ClientID %>').val());
    }
