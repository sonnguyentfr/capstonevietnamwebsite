<%@ Control Language="vb" AutoEventWireup="false" Explicit="true" CodeFile="inc_editHuyXuatBan.ascx.vb" Inherits="DesktopModules.TinTuc.Manager.news.newsedit" EnableViewState="true" %>
            ...
            <div class="card card-bordered">
                <div class="card-header border-bottom">
                    <ul class="cc_button">
                        ...
                        <li>
                            <asp:LinkButton ID="lbtXuatBan" ValidationGroup="InputValidateNewsNotepop3" runat="server" Font-Bold="True" CssClass="btn btn-sm btn-danger">
                                <span>Xuất bản lại</span> <em class="icon ni ni-check-circle"></em>
                            </asp:LinkButton>
                        </li>
                        <li>
        ...
        <div class="card-inner">
            ...
            <div id="checkbox-tree">
                <ul>
                    ...
                    <div class="form-group">
                        <div class="card-inner2 bg-indigo" style="padding: 10px;">
                            <h6 class="overline-title title text-danger">NGÀY GIỜ HỦY XUẤT BẢN</h6>
                            <asp:TextBox ID="txtunPublishedDate" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            <hr />
                            <h6 class="overline-title title text-danger">NGƯỜI HỦY XUẤT BẢN</h6>
                            <asp:Literal ID="ltrUserUnpulioch" runat="server"></asp:Literal>
                        </div>
                    </div>
    ...
    function callbackSaveData() {
        if (formModified) {
            if (Page_ClientValidate("InputValidate")) {
                ...
                AutoSave(sID + "~!@|" + title + "~!@|" + img + "~!@|" + bHotCat + "~!@|" + bHotSite + "~!@|" + category + "~!@|" + subcategory + "~!@|" + summary + "~!@|" + he + "~!@|" + data + "~!@|" + nguontin + "~!@|" + arrdongtg + "~!@|" + luuy + "~!@|" + links + "~!@|" + anhdd + "~!@|" + mediaList + "~!@|" + imgList + "~!@|" + bisVideo + "~!@|" + bisPhoto + "~!@|" + bisPR + "~!@|" + bisShowBaiMoi + "~!@|" + bisAMP + "~!@|" + bisHienQuangCao + "~!@|" + bisAnNoiDung + "~!@|" + keyword + "~!@|" + butdanh + "~!@|" + SourceText + "~!@|" + chkconfighotslide + "~!@|" + chkconfigtinnong + "~!@|" + chkconfigxuhuongdoc + "~!@|" + txtTags  + "~!@|" + txtPublishedDate);
            }
        }
    }
