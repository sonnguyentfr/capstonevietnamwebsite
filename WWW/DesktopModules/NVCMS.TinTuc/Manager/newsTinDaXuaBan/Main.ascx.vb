        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            Try
                ...
                Select Case Request.Item("view")
                    ...
                    Case "editimg"
                        DynamicPage = DotNetNuke.Common.ResolveUrl(Me.TemplateSourceDirectory & "/inc_editimg.ascx")
                    Case "view"
                        DynamicPage = DotNetNuke.Common.ResolveUrl(Me.TemplateSourceDirectory & "/inc_view.ascx")
                    Case "viewimg"
                        DynamicPage = DotNetNuke.Common.ResolveUrl(Me.TemplateSourceDirectory & "/inc_viewimg.ascx")
                    Case "process"
