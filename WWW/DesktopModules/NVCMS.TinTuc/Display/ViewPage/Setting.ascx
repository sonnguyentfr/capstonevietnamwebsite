...
<div class="dnnForm dnnHTMLSettings dnnClear ib-setting">
    <div class="box">
        <fieldset class="fieldset">
            <h5>Cấu hình tin nổi bật mục</h5>
            <div class="dnnFormItem">
                <dnn:Label ID="Label2" ControlName="txtList_PageSize" Text="Số lượng tin HOT" runat="server" />
                <asp:TextBox ID="txtHot_PageSize" runat="server" />
            </div>
            <div class="dnnFormItem">
                <dnn:Label ID="Label3" ControlName="txtList_ImgWidth" Text="Kích thước ảnh HOT" runat="server" />
                <asp:TextBox ID="txtHot_ImgWidth" runat="server" Width="30" />
                <span>x</span>
                <asp:TextBox ID="txtHot_ImgHeight" runat="server" Width="30" />
            </div>
        </fieldset>
        <fieldset class="fieldset">
            ...
            <div class="dnnFormItem">
                ...
                <asp:TextBox ID="txtList_ImgWidth" runat="server" Width="30" />
                <span>x</span>
                <asp:TextBox ID="txtList_ImgHeight" runat="server" Width="30" />
            </div>
            <div class="dnnFormItem">
                <dnn:Label ID="lbList_Order" ControlName="cbList_Order" Text="Sắp xếp" runat="server" />
                <asp:DropDownList ID="cbList_Order" runat="server">
                    <Items>
                        <asp:ListItem Value="DATE_DESC" Text="Ngày đăng mới nhất" />
                        <asp:ListItem Value="TITLE_ASC" Text="Tên tăng dần" />
                        <asp:ListItem Value="TITLE_DESC" Text="Tên giảm dần" />
                        <asp:ListItem Value="VIEW_ASC" Text="Lượt Xem nhiều nhất" />
                        <asp:ListItem Value="VIEW_DESC" Text="LƯợt Xem ít nhất" />
                    </Items>
                </asp:DropDownList>
            </div>
            <div class="dnnFormItem">
                <dnn:Label ID="lbList_SizeDes" ControlName="txtList_SizeDes" Text="Giới hạn ký tự mô tả" runat="server" />
                <asp:TextBox ID="txtList_SizeDes" runat="server" Width="30" />
            </div>
            <div class="dnnFormItem">
        ...
        <fieldset class="fieldset">
            ...
            <%--<div class="dnnFormItem">
                <dnn:Label ID="lbDetails_More" ControlName="txtDetails_More" Text="SL Tin liên quan" runat="server" />
                <asp:TextBox ID="txtDetails_More" runat="server" Width="30" />
            </div>--%>
            <div class="dnnFormItem" style="display: none;">
                <dnn:Label ID="lbDetails_Other" ControlName="txtDetails_Other" Text="SL tin mới cập nhật" runat="server" />
                <asp:TextBox ID="txtDetails_Other" runat="server" Width="30" />
            </div>
            <div class="dnnFormItem">
                <dnn:Label ID="lbDetails_Cmt" ControlName="txtDetails_Cmt" Text="SL bình luận / trang" runat="server" />
                <asp:TextBox ID="txtDetails_Cmt" runat="server" Width="30" />
            </div>
        ...
        <fieldset class="fieldset">
            ...
            <div class="dnnFormItem">
                ...
                <asp:TextBox ID="txttincungchuyenmucsoluong" runat="server" Width="30" />
            </div>
            <div class="dnnFormItem" id="div_rdGetType_Scroll" runat="server" visible="false">
                ...
                <asp:TextBox ID="txttincungchuyenmucsotrang" runat="server" Width="30" />
            </div>
