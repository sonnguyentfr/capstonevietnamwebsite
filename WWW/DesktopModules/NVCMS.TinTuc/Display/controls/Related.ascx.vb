        ...
        Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
            If Not Page.IsPostBack Then
                ...
                If Not objNews Is Nothing Then
                    With objNews
                        hdfcatid.Value = .CategoryId.ToString()
                        hplCat.NavigateUrl = NavigateURL(BL.GetMappingTabIDByCategoryID(.CategoryId))
                        hplCat.ToolTip = .CategoryName
                        'Dim arr2 As ArrayList = ctlNews.ShowSelectNewsInSameCat(ItemID, .CategoryId, 9)
                        Dim arr2 As ArrayList = ctlNews.SelectIndex(ItemID, .CategoryId, 0, 1, 5, "", False)
