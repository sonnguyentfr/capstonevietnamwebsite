<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="List.ascx.vb" Inherits="NVCMS.Modules.BannerAdv.List" %>
            ...
            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                <thead>
                    <tr class="nk-tb-item nk-tb-head">
                        ...
                        <th class="nk-tb-col"><span class="sub-text">Tên vị trí</span></th>
                                ...
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        <div class="news-avatar xs bg-primary">
                                            <a href="<%# Ultis.FormatFullImage(Eval("Images")) %>" data-fancybox data-caption="" class="usernewsimage" data-toggle="tooltip" data-placement="top" title="Xem ảnh lớn">
                                                <asp:Image ImageUrl='<%# Ultis.FormatThumbImage(Eval("Images"), 140, 80, "", "", "", "") %>' AlternateText="" ID="imgNews" runat="server" />
                                            </a>
                                        </div>
                                        <div class="user-info">
                                            <span class="tb-lead"><%# Eval("Title")%> <span class="dot dot-success d-md-none ml-1"></span></span>
                                        </div>
                                    </div>
                                </td>
