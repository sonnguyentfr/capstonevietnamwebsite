<%@ Control Language="vb" EnableViewState="true" AutoEventWireup="false" Explicit="true"
    CodeFile="DetailUniversity.ascx.vb" Inherits="DesktopModules.TinTuc.Display.News.Detail" %>
<style type="text/css">
    .icontitle {
        position: absolute;
        top: 0px;
...
<div class="row schooldetail">
    ...
    <div class="col-lg-4 col-md-6">
        ...
        <div class="fairguide_thongtin">
            ...
            <p>
                <strong>Vị trí:
                <asp:Literal ID="txtvitri" runat="server"></asp:Literal></strong>
            </p>
            <p>
                <strong>Địa chỉ:</strong><asp:Literal ID="txtdiachia" runat="server"></asp:Literal>
            </p>
            <p>
                <strong>Loai trường: </strong>
    ...
    <div class="col-lg-8 col-md-6">
        <div class="fairguide_cover">
            <div id="dvPreviewcover" runat="server"></div>
        </div>
    </div>
    ...
    <div class="row fairguide_tuyensinh" id="thongtintuyensinh" runat="server" visible="false">
        ...
        <div class="col-lg-3 col-md-6 fairguide_tuyensinhcontent">
            <p style="<%=CaoDang %>">
                <strong>Yêu cầu tối thiểu tiếng Anh: </strong>
                <asp:Literal ID="ltryeucautienganh2" runat="server"></asp:Literal>
            </p>
            <p style="<%=DaiHoc %>">
                <strong>Yêu cầu điểm chuẩn hóa: </strong>
                <asp:Literal ID="ltryeucaudiemchuanhoatoithieu" runat="server"></asp:Literal>
            </p>
            <p>
        ...
        <div class="col-lg-3 col-md-6 fairguide_tuyensinhcontent">
            <p>
                <strong>Các ngành hoc phổ biến: </strong>
                <asp:Literal ID="ltrnganhhocphobien" runat="server"></asp:Literal>
            </p>
