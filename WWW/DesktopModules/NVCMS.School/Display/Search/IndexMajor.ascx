<%@ Control Language="vb" EnableViewState="false" AutoEventWireup="false" Explicit="true" CodeFile="IndexMajor.ascx.vb" Inherits="NVCMS.Modules.School.IndexSearch" %>
...
<style type="text/css">
    ...
    .list-school {
        ...
        .list-school .majorsearch li a.active {
            color: red;
            background: yellow;
        }

        .list-school ul.majorsearch {
...
<div class="list-school row">
    <div class="col-lg-12 col-sm-12">
        <asp:Repeater ID="rptMajor" runat="server">
            <HeaderTemplate>
                <ul class="majorsearch">
            </HeaderTemplate>
            <ItemTemplate>
                <li><a class='<%#getactive(Eval("Id")) %>' href="/tim-nganh-hoc?major=<%#Eval("Id") %>"><%#Eval("Title") %></a></li>
            </ItemTemplate>
