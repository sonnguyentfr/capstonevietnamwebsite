...
namespace NVCMS.Modules.SchoolWebsite
{
    ...
    {
        private string PageAddURL = "/quan-tri/doi-tac/quan-tri-template?mod=edit";
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                MarketingSchoolTemplateInfo template = controller.GetTemplate(PortalId, templateID);
                if (template != null)
                {
                    string filePath = PortalSettings.HomeDirectoryMapPath + "/SchoolTemplates/" + template.FilePath;
        ...
        protected void gridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowIndex >= 0) //Bo qua dong dau
                {
                    ...
                    e.Row.Cells[2].Text = PortalSettings.HomeDirectory + "SchoolTemplates/" + e.Row.Cells[2].Text;
