...
namespace NVCMS.Modules.SchoolWebsite
{
  ...
  "óòọỏõôốồộổỗơớờợởỡ", "úùụủũưứừựửữ", "íìịỉĩ","đ", "ýỳỵỷỹ", };
        ...
        private string PageListURL = "/quan-tri/doi-tac/quan-tri-template";
        private string folderPath;

        MarketingSchoolTemplateController controller = new MarketingSchoolTemplateController();
        protected void Page_Load(object sender, EventArgs e)
        {
            folderPath = PortalSettings.HomeDirectoryMapPath + "SchoolTemplates";
        ...
        private void FillData()
        {
            ...
            MarketingSchoolTemplateInfo template = controller.GetTemplate(PortalId, id);
            if (template == null) return;
            txtTemplateName.Value = template.TemplateName;
            txtFilePath.Value = PortalSettings.HomeDirectory + "/SchoolTemplates/" + template.FilePath;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            MarketingSchoolTemplateInfo template = (id == -1 ? new MarketingSchoolTemplateInfo() : controller.GetTemplate(PortalId, id));
