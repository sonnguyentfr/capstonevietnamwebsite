<%@ WebHandler Language="VB" Class="doi.upload.UploadImageBannerFomr" %>
...
Namespace doi.upload
    Public Class UploadImageBannerFomr : Implements IHttpHandler
        ...
        Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
            ...
            Integer.TryParse(context.Request.QueryString("moduleid"), moduleid)
            ...
            If context.Request.Files.Count > 0 Then
                For i As Integer = 0 To context.Request.Files.Count - 1
                    ...
                    'Set the File Name.
                    Dim fileName As String = DateTime.Now.ToString("yyyyMMddHHmmss") & "-" & UserController.GetCurrentUserInfo().UserID & ReplaceChuoi.bodautenfile(Path.GetFileName(postedFile.FileName))
                    ...
                    Else
                        ...
                        If (filesize / 1048576) < 50 Then
                            ...
                            objModules.UpdateModuleSetting(moduleid, "FormOptionDisPlay_Background", tenfile)
                            ...
                            'idmedia = ctlMedia._Insert(fileName, fileName, Ultis.GetImagePath(False, PortalSettings.Current.PortalId, True), Ultis.GetMediaPath(PhotoVirtualPath, fileName), filesize, sextension, DateTime.Now, UserController.GetCurrentUserInfo().UserID, PortalSettings.Current.PortalId)
                            'chen vao bang product media
                            'ctlMediaNews._Insert(itemid, idmedia, DateTime.Now, UserController.GetCurrentUserInfo().UserID, PortalSettings.Current.PortalId)
                        Else
                            context.Response.Write("<script type='text/javascript'>alert('Ảnh quá lớn! ');</script>")
                        End If
