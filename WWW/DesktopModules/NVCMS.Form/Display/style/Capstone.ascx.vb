...
Namespace NVCMS.Modules.Form
    Public MustInherit Class Defaultz
        ...
        Dim ctrlGoogleReCaptcha As New GoogleReCaptcha.GoogleReCaptcha()
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                ...
                Else
                    If Not Null.IsNull(PortalController.GetPortalSetting(nvcmsBL.settingPagesiteNhanMailList, PortalSettings.Current.PortalId, Null.NullString)) Then
                        settingnhanmail = PortalController.GetPortalSetting(nvcmsBL.settingPagesiteNhanMailList, PortalSettings.Current.PortalId, Null.NullString)
                    End If
        ...
        Private Sub btnSend_Click(sender As Object, e As EventArgs) Handles btnSend.Click
            ...
            Else
                settingmail = "info@capstonevietnam.com"
            End If
            ...
            End If
            'Lay du lieu
            Dim title = Ultis.ConvertStringNonAttact(txtTitle.Text)
            Dim noidung = Ultis.ConvertStringNonAttact(txtcontent.Text)
            Dim hovaten = Ultis.ConvertStringNonAttact(txtFullName.Text)
            Dim email = Ultis.ConvertStringNonAttact(txtEmail.Text)
            Dim sodienthoai = Ultis.ConvertStringNonAttact(txtPhone.Text)
            '=================
            ...
            If isValid Then
                Ultis.FormInsert("LIENHE", "KO", "KO", title, noidung, hovaten, email, sodienthoai, "", "VUATIEPNHAN", PortalId)
