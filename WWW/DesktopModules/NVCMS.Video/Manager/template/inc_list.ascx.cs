...
namespace DesktopModules.TinTuc.Manager.template
{
    ...
    {
        private string PageAddURL = "/quan-tri/video-cap-cao/quan-tri-template?mod=edit";
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                Video_TemplateInfo template = controller.GetTemplate(PortalId, templateID);
                if (template != null)
                {
                    string filePath = PortalSettings.HomeDirectoryMapPath + "/VideoTemplate/" + template.FilePath;
        ...
        protected void gridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowIndex >= 0) //Bo qua dong dau
                {
                    ...
                    e.Row.Cells[2].Text = PortalSettings.HomeDirectory + "VideoTemplate/" + e.Row.Cells[2].Text;
