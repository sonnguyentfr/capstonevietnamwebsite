                    ...
                    <div class="toggle-wrap nk-block-tools-toggle">
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li><a href="/quan-tri/video/them-moi" class="btn btn-white btn-outline-light"><em class="icon ni ni-download-cloud"></em><span>Thêm mới</span></a></li>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden" id="nutsua" runat="server" visible='<%#Ultis.VideoUButtonEdit(CInt(Eval("videoid"))) %>'>
                                                    <a href="/quan-tri/video/them-moi?itemid=<%#Eval("videoid") %>" class="btn btn-trigger btn-icon user-avatar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sửa">
                                                        <em class="icon ni ni-edit-fill"></em>
                                                    </a>
                                                </li>
                                                <li class="nk-tb-action-hidden" id="nuttrieuhoi" runat="server" Visible='<%# Ultis.VideoFormatTrieuHoi(CInt(Eval("Status"))) %>'>
                                                    <asp:LinkButton ID="cmdCancelRequest" CssClass="btn btn-trigger btn-icon user-avatar" OnClick="cmdCancelRequest" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "videoid") %>' Visible='<%# Ultis.VideoFormatTrieuHoi(CInt(Eval("Status"))) %>' runat="server" data-toggle="tooltip" data-placement="top" title="" data-original-title="Thu hồi bài viết"><em class="icon ni ni-curve-up-left"></em></asp:LinkButton>
                                                </li>
                                                <li>
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a target="_blank" href='<%#Ultis.FormatLinkadminXemtruoc("/news", CInt(Eval("videoid")), CStr(Eval("Title"))) %>'><em class="icon ni ni-eye"></em><span>Xem trước</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
                            ...
                            <div class="g">
                                <div class="nk-block-head-content">
                                    <div class="toggle-wrap nk-block-tools-toggle">
                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                <li class="nk-block-tools-opt"><a href="/quan-tri/video/them-moi" class="btn btn-primary"><em class="icon ni ni-save"></em><span>Thêm mới</span></a></li>
