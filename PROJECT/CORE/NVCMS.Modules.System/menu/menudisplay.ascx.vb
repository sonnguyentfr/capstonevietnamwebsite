...
#Region "Common function"
        ...
        Private Sub InitializecboFiles()
            drlMenu.Items.Clear()
            Dim arrFile As ArrayList = GetFileList(PortalId, "xml", False, "MenusXML")
...
#Region "TreeView events"
        ...
        Protected Sub catMenu_NodeClick(sender As Object, e As RadTreeNodeEventArgs)
            ...
            If Not (currentNode Is Nothing) And Not currentNode.Value.Equals(Null.NullInteger.ToString) Then
                ...
                If Not currentNode.Attributes("Target") Is Nothing Or currentNode.Attributes("Target") = "_self" Then
                    chkLinkPopup.Checked = False
                Else
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                If Not Page.IsPostBack Then
                    InitializecboFiles()
                    BindGroups()
                    CurrentXML = "/Portals/" & PortalId.ToString & "/MenusXML/" & drlMenu.SelectedItem.Text
