...
Namespace NVCMS.Modules.EventsWebsite
    ...
    Public Class EventsWebsite_CatController
        Private Sub Clearchace()
            DataCache.ClearCache("Events_Static")
            DataCache.ClearCache("Events_Cat_GetAll")
        End Sub
#Region "Webform"
        ...
        '------------------------------------------'
        Public Function Events_Cat_GetByID(ByVal id As Integer, Portalid As Integer) As Events_CatInfo
            Return CType(CBO.FillObject(Of Events_CatInfo)(DataProvider.Instance.Events_Cat_GetByID(id, Portalid), True), Events_CatInfo)
        End Function
        '------------------------------------------'
        Public Function Events_Cat_GetByTabID(ByVal tabid As Integer) As Events_CatInfo
            Return CType(CBO.FillObject(Of Events_CatInfo)(DataProvider.Instance.Events_Cat_GetByTabID(tabid), True), Events_CatInfo)
        End Function

        '------------------------------------------'
        Public Function Events_Cat_GetAll(Portalid As Integer) As ArrayList
            'Dim stringcache = "Events_Cat_GetAll"
            'If DataCache.GetCache(stringcache) Is Nothing Then
            '    Dim arrtop = CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAll(Portalid), GetType(Events_CatInfo))
            '    DataCache.SetCache(stringcache, arrtop)
            'End If
            'Return DataCache.GetCache(stringcache)
            Return CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAll(Portalid), GetType(Events_CatInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Cat_GetAllShow(Portalid As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShow(Portalid), GetType(Events_CatInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Cat_GetAllShowOnline(Portalid As Integer) As ArrayList
            ...
            If DataCache.GetCache(stringcache) Is Nothing Then
                Dim arrtop = CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShowOnline(Portalid), GetType(Events_CatInfo))
                DataCache.SetCache(stringcache, arrtop)
            End If
            Return DataCache.GetCache(stringcache)

            'Return CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShowOnline(Portalid), GetType(Events_CatInfo))
        End Function
        Public Function Events_Cat_GetAllShowOnlineViewWebsite(Portalid As Integer) As ArrayList
            'Dim stringcache = "Events_Static" & "OnlineViewWebsite" & Portalid
            'If DataCache.GetCache(stringcache) Is Nothing Then
            '    Dim arrtop = CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShowOnlineViewWebsite(Portalid), GetType(Events_CatInfo))
            '    DataCache.SetCache(stringcache, arrtop)
            'End If
            'Return DataCache.GetCache(stringcache)

            Return CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShowOnlineViewWebsite(Portalid), GetType(Events_CatInfo))
        End Function
        ...
        Public Function Events_Cat_GetAllShowPastCount(ByVal CatName As String, Portalid As Integer) As Integer
            ...
            'Return CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShowPast(CatName, Portalid, PageIndex, PageSize), GetType(Events_CatInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Cat_GetAllShowPast(ByVal CatName As String, Portalid As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            ...
            If DataCache.GetCache(stringcache) Is Nothing Then
                Dim arrtop = CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShowPast(CatName, Portalid, PageIndex, PageSize), GetType(Events_CatInfo))
                DataCache.SetCache(stringcache, arrtop)
            End If
            Return DataCache.GetCache(stringcache)
...
#Region "API"
        '------------------------------------------'
        Public Function API_GetAll(Portalid As Integer) As List(Of Events_CatInfo)
            ...
            Dim result As ArrayList = CBO.FillCollection(DataProvider.Instance.Events_Cat_GetAllShow(Portalid), GetType(Events_CatInfo))
            Return result.Cast(Of Events_CatInfo).ToList()
        End Function
#End Region
    End Class
