...
Namespace NVCMS.Modules.Student
    ...
    Public Class EventsStudentController
        ...
        Public Function Events_Student_GetAllByEvent(EventId As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_GetAllByEvent(EventId), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Student_GetAllByStudent(StudentId As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_GetAllByStudent(StudentId), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Student_GetAllByEventCheckIn(EventId As Integer, Source As String, checkin As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_GetAllByEventCheckIn(EventId, Source, checkin), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Student_SelectAllByEventCheckInbySource(EventId As Integer, CheckIn As Boolean, Source As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_SelectAllByEventCheckInbySource(EventId, CheckIn, Source), GetType(EventsStudentInfo))
        End Function
        Public Function Events_Student_GetById(ByVal Id As Integer) As EventsStudentInfo
            Return CType(CBO.FillObject(Of EventsStudentInfo)(DataProvider.Instance.Events_Student_GetById(Id), True), EventsStudentInfo)
        End Function
        '------------------------------------------'
        Public Function Events_Student_GetAllByEventCat(EventCatId As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_GetAllByEventCat(EventCatId), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        ...
        Public Function Events_Student_SelectAllByEventCatCheckInbySource(EventCatId As Integer, CheckIn As Boolean, Source As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_SelectAllByEventCatCheckInbySource(EventCatId, CheckIn, Source), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Student_SelectAllByEventCatbySource(EventCatId As Integer, Source As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_SelectAllByEventCatbySource(EventCatId, Source), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Student_SelectAllByEventCatbyNguon(EventCatId As Integer, CheckIn As Integer, Nguon As String) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_SelectAllByEventCatbyNguon(EventCatId, CheckIn, Nguon), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Student_SelectAllByEventCatbyNguonTutao(EventCatId As Integer, CheckIn As Integer, NguonTutao As String) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_SelectAllByEventCatbyNguonTutao(EventCatId, CheckIn, NguonTutao), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        Public Function Events_Student_SelectAllByEventbyNguon(EventId As Integer, CheckIn As Integer, Nguon As String) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Student_SelectAllByEventbyNguon(EventId, CheckIn, Nguon), GetType(EventsStudentInfo))
        End Function
        ...
        Public Function Events_Student_FindIndexByEvent(EventId As Integer, EventCatId As Integer, Checkin As Integer, Source As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            ...
            If DataCache.GetCache(stringcache) Is Nothing Then
                Dim arrtop = CBO.FillCollection(DataProvider.Instance.Events_Student_FindIndexByEvent(EventId, EventCatId, Checkin, Source, PageIndex, PageSize), GetType(EventsStudentInfo))
                DataCache.SetCache(stringcache, arrtop)
            End If
            Return DataCache.GetCache(stringcache)
            'Return CBO.FillCollection(DataProvider.Instance.Events_Student_FindIndexByEvent(EventId, EventCatId, Checkin, Source, PageIndex, PageSize), GetType(EventsStudentInfo))
        End Function
        '------------------------------------------'
        ...
        End Sub
        '------------------------------------------'
        Public Function Events_Student_SelectByEventstudentid(EventCatId As Integer, studentid As Integer) As EventsStudentInfo
            Return CType(CBO.FillObject(Of EventsStudentInfo)(DataProvider.Instance.Events_Student_SelectByEventstudentid(EventCatId, studentid), True), EventsStudentInfo)
