...
Namespace NVCMS.Modules.Student
    ...
    Public Class StudentInfoController
        ...
        Public Function Info_OS_Find_Count(ByVal Action As String, ByVal Portalid As Integer) As Integer
            Dim stringcache = nvcmsBL.cacheStudent_OS_List & Action
            If DataCache.GetCache(stringcache) Is Nothing Then
                Dim icount = DataProvider.Instance.Info_OS_Find_Count(Action, Portalid)
                DataCache.SetCache(stringcache, icount)
            End If
            Return DataCache.GetCache(stringcache)
            'Return DataProvider.Instance.Info_OS_Find_Count(Action, Portalid)
        End Function
        '------------------------------------------'
        Public Function Info_OS_Find_Index(ByVal Action As String, ByVal Portalid As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            Dim stringcache = nvcmsBL.cacheStudent_OS_List & Action & PageIndex & PageSize
            If DataCache.GetCache(stringcache) Is Nothing Then
                Dim arrtop = CBO.FillCollection(DataProvider.Instance.Info_OS_Find_Index(Action, Portalid, PageIndex, PageSize), GetType(StudentInfoinfo))
                DataCache.SetCache(stringcache, arrtop)
            End If
            Return DataCache.GetCache(stringcache)
            'Return CBO.FillCollection(DataProvider.Instance.Info_OS_Find_Index(Action, Portalid, PageIndex, PageSize), GetType(StudentInfoInfo))
        End Function

        '=====
        '=phan cũ
        Public Function _Info_Insert(ByVal obj As StudentInfoInfo) As Integer
            Return DataProvider.Instance._Info_Insert(obj)
        End Function
        '------------------------------------------'
        ...
        Public Function _Info_GetAll() As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_GetAll(), GetType(StudentInfoinfo))
        End Function
        '------------------------------------------'
        Public Function _Info_GetAllSDT() As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_GetAllSdt(), GetType(StudentInfoinfo))
        End Function
        '------------------------------------------'
        Public Function _Info_GetByID(ByVal id As Integer) As StudentInfoinfo
            Return CType(CBO.FillObject(Of StudentInfoinfo)(DataProvider.Instance._Info_GetByID(id), True), StudentInfoinfo)
        End Function
        '------------------------------------------'
        Public Function _Info_GetByCode(ByVal Code As String) As StudentInfoinfo
            Return CType(CBO.FillObject(Of StudentInfoinfo)(DataProvider.Instance._Info_GetByCode(Code), True), StudentInfoinfo)
        End Function
        '------------------------------------------'
        Public Function _Info_GetBySearch(ByVal key As String) As StudentInfoinfo
            Return CType(CBO.FillObject(Of StudentInfoinfo)(DataProvider.Instance._Info_GetBySearch(key), True), StudentInfoinfo)
        End Function
        '------------------------------------------'
        Public Function _Info_GetByEmail(ByVal Email As String) As StudentInfoinfo
            Return CType(CBO.FillObject(Of StudentInfoinfo)(DataProvider.Instance._Info_GetByEmail(Email), True), StudentInfoinfo)
        End Function
        '------------------------------------------'
        Public Function _Info_GetByEmailAll(ByVal Email As String) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_GetByEmail(Email), GetType(StudentInfoinfo))
        End Function
        Public Function _Info_GetTrungEmail() As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_GetTrungEmail(), GetType(StudentInfoinfo))
        End Function
        Public Function _Info_GetBySodienthoai(ByVal Sodienthoai As String) As StudentInfoinfo
            Return CType(CBO.FillObject(Of StudentInfoinfo)(DataProvider.Instance._Info_GetBySodienthoai(Sodienthoai), True), StudentInfoinfo)
        End Function
        Public Function _Info_GetBySodienthoaiAll(ByVal Sodienthoai As String) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_GetBySodienthoai(Sodienthoai), GetType(StudentInfoinfo))
        End Function
        Public Function _Info_GetTrungSodienthoai() As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_GetTrungSodienthoai(), GetType(StudentInfoinfo))
        End Function
        ...
        Public Function _Info_Find_Index(ByVal subtractIds As String, fromdate As DateTime, enddate As DateTime, Vp As Integer, ByVal fullname As String, Email As String, Sodienthoai As String, Bachoc As String, Quociga As String, Status As Integer, sex As Integer, Khanangchitra As Integer, location As String, Namsinh As Integer, Namsinhto As Integer, KyHopDong As Boolean, Sukien As Integer, EventCatId As Integer, EventId As Integer, Checkin As Integer, ByVal Portalid As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            'Dim stringcache = nvcmsBL.cacheStudent_OS_List & fullname & Vp & Email & Sodienthoai & Bachoc & Quociga & Status & sex & Khanangchitra & location & Namsinh & Namsinhto & KyHopDong & Sukien & EventCatId & EventId & Checkin & Portalid & PageIndex & PageSize
            'If DataCache.GetCache(stringcache) Is Nothing Then
            '    Dim arrtop = CBO.FillCollection(DataProvider.Instance._Info_Find_Index(subtractIds, fromdate, enddate, Vp, fullname, Email, Sodienthoai, Bachoc, Quociga, Status, sex, Khanangchitra, location, Namsinh, Namsinhto, KyHopDong, Sukien, EventCatId, EventId, Checkin, Portalid, PageIndex, PageSize), GetType(StudentInfoInfo))
            '    DataCache.SetCache(stringcache, arrtop)
            'End If
            'Return DataCache.GetCache(stringcache)
            Return CBO.FillCollection(DataProvider.Instance._Info_Find_Index(subtractIds, fromdate, enddate, Vp, fullname, Email, Sodienthoai, Bachoc, Quociga, Status, sex, Khanangchitra, location, Namsinh, Namsinhto, KyHopDong, Sukien, EventCatId, EventId, Checkin, Portalid, PageIndex, PageSize), GetType(StudentInfoinfo))
        End Function
        '------------------------------------------'
        ...
        Public Function _Info_Campaign_Find_Index(ByVal subtractIds As String, Vp As Integer, ByVal fullname As String, Email As String, Sodienthoai As String, Bachoc As String, Status As Integer, sex As Integer, Khanangchitra As Integer, location As String, Namsinh As Integer, Namsinhto As Integer, Sukien As Integer, EventCatId As Integer, EventId As Integer, Checkin As Integer, ByVal Portalid As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_Campaign_Find_Index(subtractIds, Vp, fullname, Email, Sodienthoai, Bachoc, Status, sex, Khanangchitra, location, Namsinh, Namsinhto, Sukien, EventCatId, EventId, Checkin, Portalid, PageIndex, PageSize), GetType(StudentInfoinfo))
        End Function
        ...
        Public Function _Info_FindPermissionUser_Index(ByVal AdviserId As Integer, vp As Integer, tinh As Integer, hinhthuc As Integer, sukien As Integer, trangthai As Integer, Email As String, Sodienthoai As String, ByVal Portalid As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_FindPermissionUser_Index(AdviserId, vp, tinh, hinhthuc, sukien, trangthai, Email, Sodienthoai, Portalid, PageIndex, PageSize), GetType(StudentInfoinfo))
        End Function
        '------------------------------------------'
        ...
        Public Function _Info_UserFind_Index(control As Integer, ByVal fullname As String, Code As String, vp As Integer, Email As String, Sodienthoai As String, Bachoc As String, quocgia As String, Status As Integer, sex As Integer, Khanangchitra As Integer, location As String, Namsinh As Integer, Namsinhto As Integer, hinhthuc As Integer, EventCatId As Integer, EventId As Integer, Checkin As Integer, UserId As Integer, ByVal Portalid As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            'Dim stringcache = "StudentList" & fullname & Code & vp & Email & Sodienthoai & Bachoc & quocgia & Status & sex & Khanangchitra & location & Namsinh & Namsinhto & hinhthuc & EventCatId & EventId & Checkin & UserId & Portalid & PageIndex & PageSize
            'If DataCache.GetCache(stringcache) Is Nothing Then
            '    Dim arrtop = CBO.FillCollection(DataProvider.Instance._Info_UserFind_Index(control, fullname, Code, vp, Email, Sodienthoai, Bachoc, quocgia, Status, sex, Khanangchitra, location, Namsinh, Namsinhto, hinhthuc, EventCatId, EventId, Checkin, UserId, Portalid, PageIndex, PageSize), GetType(StudentInfoInfo))
            '    DataCache.SetCache(stringcache, arrtop)
            'End If
            'Return DataCache.GetCache(stringcache)
            Return CBO.FillCollection(DataProvider.Instance._Info_UserFind_Index(control, fullname, Code, vp, Email, Sodienthoai, Bachoc, quocgia, Status, sex, Khanangchitra, location, Namsinh, Namsinhto, hinhthuc, EventCatId, EventId, Checkin, UserId, Portalid, PageIndex, PageSize), GetType(StudentInfoinfo))
        End Function
        '------------------------------------------'
        ...
        Public Function _Info_UserFollowFind_Index(control As Integer, ByVal fullname As String, vp As Integer, Email As String, Sodienthoai As String, Bachoc As String, Status As Integer, sex As Integer, Khanangchitra As Integer, location As String, Namsinhfrom As Integer, Namsinhto As Integer, hinhthuc As Integer, phuongthuc As Integer, EventCatId As Integer, datefrom As DateTime, dateto As DateTime, Checkin As Integer, UserId As Integer, ByVal Portalid As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance._Info_UserFollowFind_Index(control, fullname, vp, Email, Sodienthoai, Bachoc, Status, sex, Khanangchitra, location, Namsinhfrom, Namsinhto, hinhthuc, phuongthuc, EventCatId, datefrom, dateto, Checkin, UserId, Portalid, PageIndex, PageSize), GetType(StudentInfoinfo))
        End Function
        '------------------------------------------'
