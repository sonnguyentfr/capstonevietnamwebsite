<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Edit.ascx.vb" Inherits="NVCMS.Modules.Banner.editbanner" %>
                ...
                <div class="row g-3 align-center">
                    <div class="col-lg-7">
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-label" for="site-name">Mô tả</label>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <textarea type="text" id="Descreption" runat="server" required="required" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
