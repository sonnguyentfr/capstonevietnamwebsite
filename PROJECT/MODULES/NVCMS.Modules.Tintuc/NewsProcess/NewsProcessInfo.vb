...
Namespace NVCMS.Modules.TinTuc
    Public Class NewsProcessInfo
        ...
        Public Sub New(ByVal ID As Integer, ByVal NewsID As Integer, ByVal StatusID As Integer, ByVal ProcessName As String, ByVal Comment As String, ByVal ByUser As Integer, ByVal ToUser As Integer, ByVal CreateDate As DateTime, ByVal VersionId As Integer, ByVal IPTrack As String)
            Me.ID = ID
            Me.NewsID = NewsID
