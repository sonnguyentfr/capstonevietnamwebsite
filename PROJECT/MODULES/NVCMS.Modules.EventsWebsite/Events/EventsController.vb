...
Namespace NVCMS.Modules.EventsWebsite
    ...
    Public Class EventsWebsiteController
        ...
        '------------------------------------------'
        Public Function Events_GetByID(ByVal id As Integer, Portalid As Integer) As EventsInfo
            Return CType(CBO.FillObject(Of EventsInfo)(DataProvider.Instance.Events_GetByID(id, Portalid), True), EventsInfo)
        End Function

        '------------------------------------------'
        Public Function Events_GetAll(Portalid As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_GetAll(Portalid), GetType(EventsInfo))
        End Function
        '------------------------------------------'
        Public Function Events_GetAllByCat(CatId As Integer, Portalid As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_GetAllByCat(CatId, Portalid), GetType(EventsInfo))
        End Function
        '------------------------------------------'
        Public Function Events_GetAllShowByCat(CatId As Integer, Portalid As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_GetAllShowByCat(CatId, Portalid), GetType(EventsInfo))
        End Function
        ...
        Public Function Events_Find_Index(ByVal subtractIds As String, ByVal datefrom As Date, ByVal dateto As Date, ByVal title As String, CatId As Integer, ByVal PortalId As Integer, ByVal Isactive As Integer, ByVal UserId As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_Find_Index(subtractIds, datefrom, dateto, title, CatId, PortalId, Isactive, UserId, PageIndex, PageSize), GetType(EventsInfo))
        End Function
        '------------------------------------------'
        ...
        Public Function Events_FindShow_Index(ByVal subtractIds As String, ByVal PortalId As Integer, ByVal Isactive As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_FindShow_Index(subtractIds, PortalId, Isactive, PageIndex, PageSize), GetType(EventsInfo))
        End Function
        '------------------------------------------'
        ...
        Public Function Events_FindShowPast_Index(ByVal subtractIds As String, ByVal PortalId As Integer, ByVal Isactive As Integer, ByVal PageIndex As Integer, ByVal PageSize As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_FindShowPast_Index(subtractIds, PortalId, Isactive, PageIndex, PageSize), GetType(EventsInfo))
        End Function
        '------------------------------------------'
        Public Function Events_GetAllShow(Portalid As Integer, Count As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_GetAllShow(Portalid, Count), GetType(EventsInfo))
        End Function
        '------------------------------------------'
        '------------------------------------------'
        Public Function Events_GetAllOnline(Portalid As Integer, Count As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_GetAllOnline(Portalid, Count), GetType(EventsInfo))
        End Function
        '------------------------------------------'
        Public Function Events_GetAllShowEnd(Portalid As Integer, Count As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance.Events_GetAllShowEnd(Portalid, Count), GetType(EventsInfo))
        End Function
    End Class
