...
Namespace NVCMS.Modules.EventsWebsite
    Public Class Events_CatInfo
        ...
        Private _link_pr As String
        Private _link_data_google_sheet As String
        Private _link_data_google_sheet_range As String
        Private _is_show_website As Boolean
        '------------------------------------------'
        ...
        End Property
        '------------------------------------------'
        Public Property link_pr() As String
            Get
                Return _link_pr
            End Get
            Set(ByVal Value As String)
        ...
        End Property
        '------------------------------------------'
        Public Property link_data_google_sheet() As String
            Get
                Return _link_data_google_sheet
            End Get
            Set(ByVal Value As String)
                _link_data_google_sheet = Value
            End Set
        End Property
        '------------------------------------------'
        Public Property link_data_google_sheet_range() As String
            Get
                Return _link_data_google_sheet_range
            End Get
            Set(ByVal Value As String)
                _link_data_google_sheet_range = Value
            End Set
        End Property
        '------------------------------------------'
        Public Property is_show_website() As Boolean
            Get
                Return _is_show_website
            End Get
            Set(ByVal Value As Boolean)
                _is_show_website = Value
            End Set
        End Property
    End Class
End Namespace